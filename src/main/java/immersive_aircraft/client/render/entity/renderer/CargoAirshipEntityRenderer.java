...
public class CargoAirshipEntityRenderer<T extends AirshipEntity> extends AirshipEntityRenderer<T> {
    ...
    private final Model model = new Model()
            ...
            .add(
                    new Object(id, "small_propeller_right")
                            .setAnimationConsumer(
                                    (entity, yaw, tickDelta) -> {
                                        GlStateManager.translate(-1.15625, 2.34375, 0.0);
                                        GlStateManager.rotate((float) (entity.engineRotation.getSmooth(tickDelta) * 170.0), 0.0f, 0.0f, 1.0f);
                                        GlStateManager.translate(1.15625, -2.34375, 0.0f);
                                    }
                            )
                            .setRenderConsumer(
                                    (entity, tickDelta) -> {
    ...
    public CargoAirshipEntityRenderer(RenderManager renderManager) {
        super(renderManager);
