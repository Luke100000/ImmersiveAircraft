...
public interface Items {
    ...
    Supplier<Item> SKYLINE_AERODYNE = register("skyline_aerodyne", () -> new AircraftItem(baseProps().stacksTo(1), world -> new SkylineAerodyneEntity(Entities.SKYLINE_AERODYNE.get(), world)));
