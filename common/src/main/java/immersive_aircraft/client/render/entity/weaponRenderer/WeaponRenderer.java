...
public abstract class WeaponRenderer<W extends Weapon> {
    public <T extends VehicleEntity> void render(T entity, W weapon, PoseStack matrixStack, SubmitNodeCollector collector, int light, float time) {
        ...
        BBModelRenderer.renderModel(model, matrixStack, collector, light, time, entity, null, 1.0f, 1.0f, 1.0f, 1.0f);
