...
public class CargoAirshipEntityRenderer<T extends AirshipEntity> extends AirshipEntityRenderer<T> {
                            ...
                            .setRenderConsumer(
                                    (vertexConsumerProvider, entity, matrixStack, light, tickDelta) -> {
                                        ...
                                        if (stack.getItem() instanceof DyeItem) {
                                            color = ((DyeItem) stack.getItem()).getColor();
                                        } else {
    ...
    public CargoAirshipEntityRenderer(EntityRenderDispatcher entityRenderDispatcher) {
    ...
    @Override
    public Vec3f getPivot(AircraftEntity entity) {
