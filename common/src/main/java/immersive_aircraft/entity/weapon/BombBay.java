...
public class BombBay extends BulletWeapon {
    ...
    protected Entity getBullet(Vector4f position, Vector3f direction) {
        ...
        return EntityType.loadEntityRecursive(compoundTag, getEntity().level(), EntitySpawnReason.TRIGGERED, (EntityProcessor) (e) -> {
            e.setPos(new Vec3(position.x(), position.y(), position.z()));
