...
public class BulletEntityRenderer<T extends BulletEntity> extends LegacyEntityRenderer<T> {
    ...
    @Override
    protected void renderLegacy(T entity, float entityYaw, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int packedLight, CameraRenderState cameraState) {
