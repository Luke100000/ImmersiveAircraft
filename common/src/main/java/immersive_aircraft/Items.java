...
public interface Items {
    ...
    Supplier<Item> ENHANCED_PROPELLER = register("enhanced_propeller", () -> new Item(baseProps().maxCount(8)));
    Supplier<Item> ECO_ENGINE = register("eco_engine", () -> new Item(baseProps().maxCount(8)));
    Supplier<Item> NETHER_ENGINE = register("nether_engine", () -> new Item(baseProps().maxCount(8)));
    Supplier<Item> STEEL_BOILER = register("steel_boiler", () -> new Item(baseProps().maxCount(8)));
    Supplier<Item> INDUSTRIAL_GEARS = register("industrial_gears", () -> new Item(baseProps().maxCount(8)));
    Supplier<Item> STURDY_PIPES = register("sturdy_pipes", () -> new Item(baseProps().maxCount(8)));
    Supplier<Item> GYROSCOPE = register("gyroscope", () -> new Item(baseProps().maxCount(8)));
    Supplier<Item> HULL_REINFORCEMENT = register("hull_reinforcement", () -> new Item(baseProps().maxCount(8)));
    Supplier<Item> IMPROVED_LANDING_GEAR = register("improved_landing_gear", () -> new Item(baseProps().maxCount(8)));
