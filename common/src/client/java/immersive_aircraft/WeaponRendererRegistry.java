...
public class WeaponRendererRegistry {
    public static final Map<Identifier, WeaponRenderer<Weapon>> REGISTRY = new HashMap<>();

    public static void register(Identifier id, WeaponRenderer<Weapon> renderer) {
    ...
    public static WeaponRenderer<Weapon> get(Weapon weapon) {
        return REGISTRY.get(BuiltInRegistries.ITEM.getKey(weapon.getStack().getItem()));
    }
}
