package immersive_aircraft.server;
...
public class Command {
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
        dispatcher.register(CommandManager.literal("immersive-aircraft")
    ...
    private static int displayHelp(CommandContext<ServerCommandSource> ctx) {
        ...
        sendMessage(player, WHITE + " /immersive-aircraft help " + GOLD + " - Displays this help.");
