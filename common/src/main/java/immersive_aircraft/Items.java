...
public interface Items {
    ...
    Supplier<Item> ECO_ENGINE = register("eco_engine", () -> new UpgradeItem(baseProps().maxCount(8), new AircraftUpgrade().set(AircraftStat.STRENGTH, -0.2f).set(AircraftStat.FUEL, -0.75f)));
